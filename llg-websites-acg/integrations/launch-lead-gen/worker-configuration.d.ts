/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 208469895bcc4691a115e9db5b2eeea5)
// Runtime types generated with workerd@1.20260730.1 2026-08-05 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	EVENTS_QUEUE: Queue;
	ENVIRONMENT: "staging";
	DRY_RUN: "true";
	DELIVERY_ENABLED: "false";
	DRAINSCAPES_MUTATIONS_ENABLED: "false";
	DRAINSCAPES_REPORT_CHANNEL: "dashboard";
	WEBSITE_PRODUCTION_ORIGINS_ENABLED: "true";
	PUBLIC_BASE_URL: "https://launch-lead-gen-integrations-staging.justin-b75.workers.dev";
	SUPABASE_URL: "https://zjhpxhyqdrrrwoadjdbj.supabase.co";
	SUPABASE_PUBLISHABLE_KEY: "sb_publishable_XNXU1tC5v7FMlk4VsWy2rg_H317VOz-";
	GOOGLE_ADS_API_VERSION: "v25";
	GOOGLE_ADS_CUSTOMER_IDS: "5488468890";
	GOOGLE_ADS_LOGIN_CUSTOMER_ID: "";
	META_GRAPH_VERSION: "v23.0";
	META_AD_ACCOUNT_IDS: "8249616688465280";
	TEXTMAGIC_USERNAME: "effectlocal";
	TEXTMAGIC_DEFAULT_FROM: "+18337689020";
	TEXTMAGIC_DELIVERY_ENABLED: "false";
	TURNSTILE_SECRET_KEY: string;
	TURNSTILE_EXPECTED_ACTION: "lead_submit";
	ROUTE_SEQUENCER: DurableObjectNamespace<import("./src/index").RouteSequencer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RouteSequencer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DRY_RUN" | "DELIVERY_ENABLED" | "DRAINSCAPES_MUTATIONS_ENABLED" | "DRAINSCAPES_REPORT_CHANNEL" | "WEBSITE_PRODUCTION_ORIGINS_ENABLED" | "PUBLIC_BASE_URL" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "GOOGLE_ADS_API_VERSION" | "GOOGLE_ADS_CUSTOMER_IDS" | "GOOGLE_ADS_LOGIN_CUSTOMER_ID" | "META_GRAPH_VERSION" | "META_AD_ACCOUNT_IDS" | "TEXTMAGIC_USERNAME" | "TEXTMAGIC_DEFAULT_FROM" | "TEXTMAGIC_DELIVERY_ENABLED" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_EXPECTED_ACTION">> {}
}
